...
/* allow_cached should always be false. It is reserved for experience_render_pixbuf_to_window*/
GdkPixbuf * experience_render_group_to_new_pixbuf (eXperienceGroup *group, GdkRectangle *dest_area, GdkRectangle * object_area, GdkRegion * dirty_region, GtkStyle * style);
...
void experience_render_cleanup (void);
